...
map.getView().fit([11968317.029458, -1538418.861640, 14119188.565516, -313774.272755], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Peta Batas Daerah Aliran Sungai</h2>';
        return titleElement;
    })(),
